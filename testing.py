...
services = []
s = add_service(services, entry=1, service_name="Test Board", info="Script-generated board.")
...
add_message_post(s, 1, "@testuser", "12:00 PM", "Today", "Post", 1, 0, "Hello, this is a test.")
